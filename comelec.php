                    ...
                    <div class="card-body table-responsive">
                        <table class="table table-hover" id="datatablesSimple">
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center">
                                            <button class="btn btn-sm btn-primary mx-3"><i class="fas fa-edit"></i>
                                                Edit</button>
                                            <button class="btn btn-sm btn-primary" tabindex="-1" data-bs-toggle="modal"
                                                data-bs-target="#view-candidate<?= $candidate['id'] ?>"><i
                                ...
                                <div class="modal fade modal-signin" id="view-candidate<?= $candidate['id'] ?>"
                                        ...
                                        <div class="modal-content rounded-5 shadow" style="border-radius: 30px;">
                                            ...
                                            <div class="modal-footer">
                                                <button type="submit" class="btn btn-danger"
                                                    name="delete-denied">Delete</button>
                                            </div>
