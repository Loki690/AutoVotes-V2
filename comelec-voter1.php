                ...
                <div class="d-flex">
                    ...
                    <div class="d-flex">
                        <form action="comelec-export.php" method="post">
                            <input type="submit" name="export" class="btn btn-success mx-2" value="Export CSV" />
                        </form>
                        <form action="comelec-export.php" method="post">
                            <input type="submit" name="export-template" class="btn btn-success" value="Export Template" />
                        </form>
                    </div>
                </div>
