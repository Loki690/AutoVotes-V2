...
<div class="modal fade modal-signin" id="add" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="modal-body p-5 pt-0">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="middle_name" class="form-control" placeholder="Middle Name" id=""
                                required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="access_code" class="form-control" placeholder="Access Code" id=""
                                value="<?= $accesscode; ?>">
                        </div>
                    </div>
                </div>
...
<!-- edit admin info -->
<div class="modal fade modal-signin" id="edit-admin<?= $item['admin_id'] ?>" data-bs-backdrop="static"
...
<!-- delete admin info -->
<div class="modal fade modal-signin" id="delete-admin<?= $item['admin_id'] ?>" data-bs-backdrop="static"
    data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
...
<div class="modal fade modal-signin" id="add-comelec" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content rounded-5 shadow" style="border-radius: 30px;">
            <div class="modal-header p-3 pb-3">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="modal-body p-5 pt-0">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="first_name" placeholder="First Name" id=""
                                required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="last_name" placeholder="Middle Name" id=""
                                required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="middle_name" placeholder="Last Name" id=""
                                required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" name="accesscode" placeholder="Access Code" id=""
                                required>
                        </div>
                    </div>
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"
                            name="school_id" placeholder="Student ID" required />
                    ...
                    <div class="d-flex pt-1">
                        <button type="submit" id="loginbutton" name="login-voter"
                            class="btn btn-primary mt-2 flex-grow-1">
                            Login
                        </button>
                    </div>
                </form>
                    ...
                    <div class="row">
                        <div class="col-sm-6 mt-3" data-aos="fade-right">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" name="first_name" placeholder="Jerecho" required />
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 mt-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" name="last_name" placeholder="Miles" required />
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 mt-3">
                            <div class="form-group">
                                <label for="exampleInputEmail1">Student ID</label>
                                <input type="text" class="form-control" id="exampleInputEmail1"
                                    aria-describedby="emailHelp" name="school_id" placeholder="Valid student ID number"
                                    required />
                            </div>
                        </div>
...
<!-- edit comelec info -->
<div class="modal fade modal-signin" id="edit-comelec<?= $comelec['admin_id'] ?>" data-bs-backdrop="static"
    data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
...
<!-- delete comelec info -->
<div class="modal fade modal-signin" id="delete-comelec<?= $comelec['admin_id'] ?>" data-bs-backdrop="static"
    data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
...
<div class="modal fade modal-signin" id="election" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content rounded-5 shadow" style="border-radius: 30px;">
            <div class="modal-header p-3 pb-3">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="modal-body p-5 pt-0">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-8">
                            <input type="date" class="form-control" name="election_date" placeholder="Election Date"
                                id="">
                        </div>
                    </div>
                    <div class="mb-3 row">
...
<!-- edit elections -->
<div class="modal fade modal-signin" id="edit-election<?= $elec['election_id'] ?>" data-bs-backdrop="static"
    data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content rounded-5 shadow" style="border-radius: 30px;">
            <div class="modal-header p-3 pb-3">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="modal-body p-5 pt-0">
                    <div class="mb-3 row">
                        <label for="ElectionName" class="col-sm-3 col-form-label">Election Name: </label>
                        <div class="col-sm-8">
                            <input type="text" class="form-control" value="<?= $elec['election_name'] ?>"
                                name="election_name" id="" required>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control"
                                value="<?= date('F d, Y g:i A', strtotime($elec['start_date'])) ?>" readonly>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control"
                                value="<?= date('F d, Y g:i A', strtotime($elec['end_date'])) ?>" readonly>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="ElectionDate" class="col-sm-3 col-form-label">Update Poster</label>
                        <div class="col-sm-8">
                            <input type="file" class="form-control" name="election_poster" id="election_poster"
                                value="uploads/<?= $elec['election_poster']; ?>">
                        </div>
                    </div>
                    <div class="mb-3 row">
...
<!-- delete election  -->
<div class="modal fade modal-signin" id="delete-election<?= $elec['election_id'] ?>" data-bs-backdrop="static"
    data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content rounded-5 shadow" style="border-radius: 30px;">
            <div class="modal-header p-3 pb-3">
...
<!-- delete voter -->
<div class="modal fade modal-signin" id="delete-voter<?= $voter['student_id'] ?>" data-bs-backdrop="static"
    data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content rounded-5 shadow" style="border-radius: 30px;">
            <div class="modal-header p-3 pb-3">
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                <div class="modal-body p-5 pt-0">
                    <div class="row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control"
                                value="<?= $voter['first_name'] . " " . $voter['middle_name'] . " " . $voter['last_name'] ?>"
                                name="election_name" id="" readonly>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                    <button type="submit" class="btn btn-danger" name="delete-voter">Delete Election</button>
                </div>
...
<!-- Adding Position -->
<div class="modal fade modal-signin" id="addPosition" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content rounded-5 shadow" style="border-radius: 30px;">
            <div class="modal-header p-3 pb-3">
...
<!-- delete posotion -->
<div class="modal fade modal-signin" id="delete-posotion<?= $pos['position_id'] ?>" data-bs-backdrop="static"
    data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content rounded-5 shadow" style="border-radius: 30px;">
            <div class="modal-header p-3 pb-3">
