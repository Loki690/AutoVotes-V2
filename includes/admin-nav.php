...
<nav class="sb-topnav navbar navbar-expand navbar-dark" id="nav-color">
    ...
    <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
        <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle user-name" id="navbarDropdown" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"><i class="fas fa-user fa-fw"></i> <?= $adminDetails['type'] ?></a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form action="" method="POST">
                    <button type="submit" class="btn btn-danger text-white" name="logout-admin">Logout</button>
                </form>
            </div>
        </div>
    </div>
