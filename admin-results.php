            ...
            <main>
                ...
                <div class="d-flex justify-content-between mt-4 mx-4 my-3">
                    ...
                    <form class="d-flex" method="post" action="">
                        <select class="form-select mx-2" name="election" aria-label="Default select example" required>
                                            ...
                                            <?php if (!empty($voteResult)) { ?>
                                                <td >
                                                    <div class="d-flex justify-content-between">
                                                        <span class="badge rounded-pill bg-success"><?= $voteResult ?> votes</span> <span class="badge rounded-pill bg-success"> <?= $isWinner ? 'Win ' : '' ?></span>
                                                    </div>
